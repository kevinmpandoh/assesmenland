...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Hop on a tiny boat, cast your line, and reel in rare fish. A chill Solana game that runs right in your browser. Open beta." },
      { property: "og:title", content: "Sawah Voyages — Sail, Cast, Chill" },
      { property: "og:description", content: "A cozy sea-life game on Solana. Connect your wallet, set sail, and start fishing — all in the browser." },
    ],
  }),
  component: Landing,
});
    ...
    <section className="relative">
      <div className="mx-auto flex max-w-3xl flex-col items-center px-4 pb-10 pt-6 text-center sm:px-6">
        ...
        <p className="mt-6 max-w-xl text-base leading-relaxed text-ink/80 sm:text-lg">
          Hop on your little boat, cast your line, and let the waves decide today's catch.
          There are common fish, weird ones, and a few that will make you yell. It all runs{" "}
          <span className="font-bold text-ocean">right in your browser</span> — no downloads, no drama.
        </p>
      ...
      <div className="flex-1 text-sm">
        {!connected && (
          <p className="text-ink/70">
            Hold at least <span className="font-bold text-ink">{MIN_TOKEN_BALANCE} token</span> to come aboard. Connect your wallet first.
          </p>
        )}
        ...
        {connected && status === "insufficient" && (
          <p className="flex items-center gap-1.5 text-ink">
            <AlertCircle className="h-4 w-4 text-sunset-deep" /> You need at least 1 token. Current balance: {balance.toLocaleString()}.
          </p>
        )}
    ...
    <section id="how" className="mx-auto max-w-6xl px-4 py-16 sm:px-6">
      <div className="mx-auto max-w-2xl text-center">
        ...
        <p className="mt-4 text-ink/80">
          From sardines you can pull all day to Mythical creatures that make global chat lose its mind.
          Eight fish only bite after sunset, and the rarest ones — honestly — are brutally hard.
          But when you finally land one? It feels really good.
        </p>
      </div>
        ...
        <div className="grid gap-0 md:grid-cols-[1fr_360px]">
          <div className="p-8 sm:p-10">
            ...
            <p className="mt-4 max-w-md text-ink/80">
              Hold at least {MIN_TOKEN_BALANCE} Sawah Voyages token to enter the harbor and set sail.
              The token is just a key — for access, cosmetics, and seasonal events.
              Not a promise of returns, not an investment pitch. Play slowly, enjoy the sea.
            </p>
...
function Roadmap() {
  const phases = [
    { q: "Q1", t: "First boat afloat", d: "Open beta, one fish per rarity, a tiny dock tucked in the corner of the map." },
    { q: "Q2", t: "First harbor opens", d: "Boats still wobble, but the fish are biting. Global chat goes live." },
    { q: "Q3", t: "Voice chat & nighttime", d: "Chat with other captains. The rare fish start showing up after sundown." },
    { q: "Q4", t: "Marketplace & cosmetics", d: "Sell sails, repaint your hull, hang lanterns. Mythical prizes get hunted for real." },
  ];
  return (
